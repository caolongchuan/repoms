...
public class OrderRetActivity extends BaseActivity<OrderRetContact.OrderRetPtr> implements OrderRetContact.OrderRetUI,
    ...
    private Spinner spRetUsers;
    private Spinner spMgrs;
    private ImageButton btnAddAsset;
    private OrderRetBean record;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_ret);
    ...
    private void initView(){
        ...
        toolbar = findViewById(R.id.tb_order_ret_list);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        toolbar.setTitle(getString(R.string.str_title_toolbar_order_ret));
        toolbar.setTitleTextColor(getResources().getColor(R.color.white));
        iconFont = Typeface.createFromAsset(getAssets(), "iconfonts/iconfont.ttf");
        spWarehouse = (Spinner) findViewById(R.id.sp_warehouse_ret);
        spRetUsers = (Spinner) findViewById(R.id.sp_from_ret);
        spMgrs = (Spinner) findViewById(R.id.sp_mgr_ret);
        odate = (TextView) findViewById(R.id.txt_retdate);
        btnAddAsset = (ImageButton) findViewById(R.id.btn_order_ret_add_asset);
        record = new OrderRetBean();
        assetListCon = (RecyclerView) findViewById(R.id.ryc_order_ret);
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.saveOk:
                        ...
                        break;
                    case R.id.localList:
                        Intent starterOrderList = new Intent(OrderRetActivity.this, OrderListActivity.class);
                        starterOrderList.putExtra("type", OrderListPresenter.TYPE_ORDER_RET);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btn_order_ret_add_asset:
                //启用手持机扫描线程
                startOrStopScan();
                break;
        }
    ...
    private void startOrStopScan(){
        if(!runFlag){
            runFlag = true;
            Thread thread = new OrderRetActivity.AssetScanThread();
            thread.start();
        }
        if (!startFlag) {
            startFlag = true;
    ...
    @Override
    public OrderRetContact.OrderRetPtr onBindPresenter() {
        return new OrderRetPresenter(this);
    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        else if(parent == spRetUsers){
            record.setUserret(key);
        }
    ...
    public void fillSpinner(int type, List<Map<String, String>> data) {
        switch(type){
            ...
            case OrderReqPresenter.TYPE_LOAD_DATA_FROMUSERS:
                spRetUsers.setAdapter(new SimpleAdapter(this, data, R.layout.simple_spinner_item, new String[]{ "name", "id"}, new int[] {R.id.txt_spinner_item_name, R.id.txt_spinner_item_key}));
                spRetUsers.setOnItemSelectedListener(this);
                break;
