...
public class OrderReqActivity extends BaseActivity<OrderReqContact.OrderReqPtr> implements OrderReqContact.OrderReqUI,
    ...
    private Spinner spReqUsers;
    private Spinner spMgrs;
    private ImageButton btnAddAsset;
    private OrderReqBean record;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_req);
    ...
    private void initView(){
        ...
        toolbar = findViewById(R.id.tb_order_req_list);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        toolbar.setTitle(getString(R.string.str_title_toolbar_order_req));
        toolbar.setTitleTextColor(getResources().getColor(R.color.white));
        iconFont = Typeface.createFromAsset(getAssets(), "iconfonts/iconfont.ttf");
        spWarehouse = (Spinner) findViewById(R.id.sp_warehouse_req);
        spReqUsers = (Spinner) findViewById(R.id.sp_from_req);
        spMgrs = (Spinner) findViewById(R.id.sp_mgr_req);
        btnAddAsset = (ImageButton) findViewById(R.id.btn_order_req_add_asset);
        odate = (TextView) findViewById(R.id.txt_reqdate);
        record = new OrderReqBean();
        assetListCon = (RecyclerView) findViewById(R.id.ryc_order_req);
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.saveOk:
                        ...
                        break;
                    case R.id.localList:
                        Intent starterOrderList = new Intent(OrderReqActivity.this, OrderListActivity.class);
                        starterOrderList.putExtra("type", OrderListPresenter.TYPE_ORDER_REQ);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btn_order_req_add_asset:
                //启用手持机扫描线程
                startOrStopScan();
                break;
        }
    ...
    private void startOrStopScan(){
        if(!runFlag){
            runFlag = true;
            Thread thread = new OrderReqActivity.AssetScanThread();
            thread.start();
        }
        if (!startFlag) {
            startFlag = true;
    ...
    @Override
    public OrderReqContact.OrderReqPtr onBindPresenter() {
        return new OrderReqPresenter(this);
    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        else if(parent == spReqUsers){
            record.setUserreq(key);
        }
    ...
    public void fillSpinner(int type, List<Map<String, String>> data) {
        switch(type){
            case OrderReqPresenter.TYPE_LOAD_DATA_WAREHOUSE:
                ...
                break;
            case OrderReqPresenter.TYPE_LOAD_DATA_FROMUSERS:
                spReqUsers.setAdapter(new SimpleAdapter(this, data, R.layout.simple_spinner_item, new String[]{ "name", "id"}, new int[] {R.id.txt_spinner_item_name, R.id.txt_spinner_item_key}));
                spReqUsers.setOnItemSelectedListener(this);
                break;
