...
@Generated(hash = 1960069293)
public Order_Out(Long pid, @NotNull String id, @NotNull String location,
        @NotNull Date outdate, @NotNull String userrec, @NotNull String usermgr,
