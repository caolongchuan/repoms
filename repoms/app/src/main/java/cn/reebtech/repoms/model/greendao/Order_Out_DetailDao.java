...
/** 
 * DAO for table "ORDER__OUT__DETAIL".
*/
public class Order_Out_DetailDao extends AbstractDao<Order_Out_Detail, Long> {

    public static final String TABLENAME = "ORDER__OUT__DETAIL";

    /**
     * Properties of entity Order_Out_Detail.<br/>
    ...
    public Order_Out_DetailDao(DaoConfig config) {
        super(config);
    }
    
    public Order_Out_DetailDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORDER__OUT__DETAIL\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_ORDER__OUT__DETAIL__id_DESC ON \"ORDER__OUT__DETAIL\"" +
                " (\"_id\" DESC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ORDER__OUT__DETAIL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Order_Out_Detail entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Order_Out_Detail entity) {
        stmt.clearBindings();
    ...
    @Override
    public Order_Out_Detail readEntity(Cursor cursor, int offset) {
        Order_Out_Detail entity = new Order_Out_Detail( //
    ...
    @Override
    public void readEntity(Cursor cursor, Order_Out_Detail entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Order_Out_Detail entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Order_Out_Detail entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Order_Out_Detail entity) {
