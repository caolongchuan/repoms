...
/** 
 * DAO for table "ORDER__REQ".
*/
public class Order_ReqDao extends AbstractDao<Order_Req, Long> {

    public static final String TABLENAME = "ORDER__REQ";

    /**
     * Properties of entity Order_Req.<br/>
    ...
    public static class Properties {
        ...
        public final static Property Reqdate = new Property(3, java.util.Date.class, "reqdate", false, "REQDATE");
        public final static Property Userreq = new Property(4, String.class, "userreq", false, "USERREQ");
    ...
    public Order_ReqDao(DaoConfig config) {
        super(config);
    }
    
    public Order_ReqDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORDER__REQ\" (" + //
                "\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: pid
                "\"ID\" TEXT NOT NULL ," + // 1: id
                "\"LOCATION\" TEXT NOT NULL ," + // 2: location
                "\"REQDATE\" INTEGER NOT NULL ," + // 3: reqdate
                "\"USERREQ\" TEXT NOT NULL ," + // 4: userreq
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_ORDER__REQ_ID ON \"ORDER__REQ\"" +
                " (\"ID\" ASC);");
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_ORDER__REQ_ID_DESC ON \"ORDER__REQ\"" +
                " (\"ID\" DESC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ORDER__REQ\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Order_Req entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(4, entity.getReqdate().getTime());
        stmt.bindString(5, entity.getUserreq());
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Order_Req entity) {
        stmt.clearBindings();
    ...
    @Override
    public Order_Req readEntity(Cursor cursor, int offset) {
        Order_Req entity = new Order_Req( //
            cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0), // pid
            cursor.getString(offset + 1), // id
            cursor.getString(offset + 2), // location
            new java.util.Date(cursor.getLong(offset + 3)), // reqdate
            cursor.getString(offset + 4), // userreq
    ...
    @Override
    public void readEntity(Cursor cursor, Order_Req entity, int offset) {
        ...
        entity.setReqdate(new java.util.Date(cursor.getLong(offset + 3)));
        entity.setUserreq(cursor.getString(offset + 4));
    ...
    @Override
    protected final Long updateKeyAfterInsert(Order_Req entity, long rowId) {
        entity.setPid(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Order_Req entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(Order_Req entity) {
