...
public class WaitBindAssets {
    ...
    @Generated(hash = 330497567)
    public WaitBindAssets(Long pid, @NotNull String id, @NotNull String name, @NotNull String clsct,
    ...
    @Generated(hash = 1388665986)
    public WaitBindAssets() {
    }
