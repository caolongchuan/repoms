...
public class OrderOutActivity extends BaseActivity<OrderOutContact.OrderOutPtr> implements OrderOutContact.OrderOutUI,
    ...
    private void initView(){
        ...
        toolbar = findViewById(R.id.tb_order_out_list);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        toolbar.setTitle(getString(R.string.str_title_toolbar_order_out));
        toolbar.setTitleTextColor(getResources().getColor(R.color.white));
        iconFont = Typeface.createFromAsset(getAssets(), "iconfonts/iconfont.ttf");
        spWarehouse = (Spinner) findViewById(R.id.sp_warehouse_out);
        spRecUsers = (Spinner) findViewById(R.id.sp_from_out);
        spMgrs = (Spinner) findViewById(R.id.sp_mgr_out);
        odate = (TextView) findViewById(R.id.txt_outdate);
        btnAddAsset = (ImageButton) findViewById(R.id.btn_order_out_add_asset);
        record = new OrderOutBean();
        assetListCon = (RecyclerView) findViewById(R.id.ryc_order_out);
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.saveOk:
                        ...
                        break;
                    case R.id.localList:
                        Intent starterOrderList = new Intent(OrderOutActivity.this, OrderListActivity.class);
                        starterOrderList.putExtra("type", OrderListPresenter.TYPE_ORDER_OUT);
    ...
    @Override
    public OrderOutContact.OrderOutPtr onBindPresenter() {
        return new OrderOutPresenter(this);
    }
    ...
    public void fillSpinner(int type, List<Map<String, String>> data) {
        switch(type){
            ...
            case OrderInPresenter.TYPE_LOAD_DATA_FROMUSERS:
                spRecUsers.setAdapter(new SimpleAdapter(this, data, R.layout.simple_spinner_item, new String[]{ "name", "id"}, new int[] {R.id.txt_spinner_item_name, R.id.txt_spinner_item_key}));
                spRecUsers.setOnItemSelectedListener(this);
                break;
    ...
    public void addScanedAsset(AssetBean data) {
        //Log.i("find asset:", data.getName() + ":" + data.getName());
        //加入到类表中
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btn_order_out_add_asset:
                //启用手持机扫描线程
                startOrStopScan();
                break;
        }
