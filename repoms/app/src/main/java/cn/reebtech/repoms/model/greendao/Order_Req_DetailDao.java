...
/** 
 * DAO for table "ORDER__REQ__DETAIL".
*/
public class Order_Req_DetailDao extends AbstractDao<Order_Req_Detail, Long> {

    public static final String TABLENAME = "ORDER__REQ__DETAIL";

    /**
     * Properties of entity Order_Req_Detail.<br/>
    ...
    public Order_Req_DetailDao(DaoConfig config) {
        super(config);
    }
    
    public Order_Req_DetailDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ORDER__REQ__DETAIL\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_ORDER__REQ__DETAIL__id_DESC ON \"ORDER__REQ__DETAIL\"" +
                " (\"_id\" DESC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ORDER__REQ__DETAIL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Order_Req_Detail entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Order_Req_Detail entity) {
        stmt.clearBindings();
    ...
    @Override
    public Order_Req_Detail readEntity(Cursor cursor, int offset) {
        Order_Req_Detail entity = new Order_Req_Detail( //
    ...
    @Override
    public void readEntity(Cursor cursor, Order_Req_Detail entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Order_Req_Detail entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Order_Req_Detail entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Order_Req_Detail entity) {
