...
public class ServerDao extends AbstractDao<Server, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Update = new Property(4, java.util.Date.class, "update", false, "UPDATE");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SERVER\" (" + //
                ...
                "\"UPDATE\" INTEGER);"); // 4: update
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_SERVER__id_DESC ON \"SERVER\"" +
                " (\"_id\" DESC);");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Server entity) {
        ...
        if (update != null) {
            stmt.bindLong(5, update.getTime());
        }
    }
    ...
    public Server readEntity(Cursor cursor, int offset) {
        Server entity = new Server( //
            ...
            cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)) // update
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Server entity, int offset) {
        ...
        entity.setUpdate(cursor.isNull(offset + 4) ? null : new java.util.Date(cursor.getLong(offset + 4)));
     }
