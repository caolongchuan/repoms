...
public class AddAssetsModel extends BaseDBModel<AssetClsct, String, IConDbListener<Integer, AssetBean, BaseResultBean>> implements AddAssetsContact.AddAssetsMdl {
    @Override
